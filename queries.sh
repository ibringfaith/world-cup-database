...
echo "$($PSQL "SELECT name FROM teams JOIN games AS g ON teams.team_id=g.opponent_id OR teams.team_id = g.winner_id WHERE g.year = 2014 AND g.round = 'Eighth-Final' ORDER BY name")"
